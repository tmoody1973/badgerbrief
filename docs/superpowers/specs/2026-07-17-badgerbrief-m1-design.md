...
Google ad tracker (no public API — M2/M3 adapter), ad-message clustering,
...
- **M2 (Sept–Oct, for Nov 3 general):** general-election data, Google ad
  transparency adapter, ad-message clustering, polling module + methodology
  labels, reminders, semantic related content, brief invalidation/refresh triggers
